            ...
            <form method="POST" action="admin-post.php">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="r_rating_login_required">
                        ...
                        <option value="2" <?= $recipe_opts['rating_login_required'] == 2 ? 'SELECTED' : ''; ?>>Yes</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control" name="r_submission_login_required">
                        <option value="1">No</option>
                        <option value="2" <?= $recipe_opts['recipe_submission_login_required'] == 2 ? 'SELECTED' : ''; ?>>Yes</option>
                    </select>
                </div>
                <div class="form-group">
