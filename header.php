			...
			<nav id="primary-menu" class="style-2">
				...
				<div class="container clearfix">
					...
					if( get_theme_mod( 'ju_header_show_cart' ) == 'yes' ) {
						...
						============================================= -->
						<div id="top-cart">
							<a href="#" id="top-cart-trigger"><i class="icon-shopping-cart"></i><span><?= WC()->cart->get_cart_contents_count(); ?></span></a>
							<div class="top-cart-content">
									...
									if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
										...
										<div class="top-cart-item clearfix">
											...
											<div class="top-cart-item-desc">
												...
												<span class="top-cart-item-quantity"><?= $cart_item['quantity']; ?></span>
											</div>
										</div>
										<?php
									}
								...
								<div class="top-cart-action clearfix">
									<span class="fleft top-checkout-price"><?= WC()->cart->get_cart_total(); ?></span>
									<a href="<?= wc_get_cart_url(); ?>" class="button button-3d button-small nomargin fright">View Cart</a>
								</div>
							</div>
						</div><!-- #top-cart end -->
					...
					if( get_theme_mod( 'ju_header_show_search' ) == 'yes' ) {
						...
						<div id="top-search">
							...
							<form action="<?= esc_url( home_url( '/' ) ); ?>" method="get">
								<input type="text" name="q" class="form-control" value="<?php the_search_query(); ?>" placeholder="<?php _e( 'Type &amp; Hit Enter..', 'wp' ); ?>">
							</form>
						</div><!-- #top-search end -->
